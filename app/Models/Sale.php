 ...
 * @property \Illuminate\Support\Carbon|null $accept_timer
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Sale whereOrderType($value)
...
class Sale extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'accept_timer' => $this->accept_timer,
            'customer_id' => $this->customer_id,
            'customer_name' => $this->customer->name,
            'warehouse_id' => $this->warehouse_id,
            'warehouse_name' => ucfirst($this->warehouse->name),
