...
export const addonsActionType = {
    FETCH_ADDONS: 'FETCH_ADDONS',
    FETCH_ADDON: 'FETCH_ADDON',
    ADD_ADDONS: 'ADD_ADDONS',
    EDIT_ADDONS: 'EDIT_ADDONS',
    DELETE_ADDONS: 'DELETE_ADDONS',
    FETCH_ALL_ADDONS: 'FETCH_ALL_ADDONS'
};
export const addonItemsActionType = {
    FETCH_ADDON_ITEMS: 'FETCH_ADDON_ITEMS',
    FETCH_ADDON_ITEM: 'FETCH_ADDON_ITEM',
    ADD_ADDON_ITEMS: 'ADD_ADDON_ITEMS',
    EDIT_ADDON_ITEMS: 'EDIT_ADDON_ITEMS',
    DELETE_ADDON_ITEMS: 'DELETE_ADDON_ITEMS',
    FETCH_ALL_ADDON_ITEMS: 'FETCH_ALL_ADDON_ITEMS'
};
...
export const constants = {
    ...
    CALL_UPDATE_ADDON_API: "CALL_UPDATE_ADDON_API",
