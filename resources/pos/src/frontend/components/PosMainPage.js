...
const PosMainPage = (props) => {
    ...
    const updateCost = (item) => {
        // console.log(item,'updateCost item ');
        setNewCost(item);
    };
    ...
    return (
        <Container className='pos-screen px-3' fluid>
            ...
            <Row>
                <TopProgressBar />
                <Col lg={12} xxl={12} xs={12} className='p-0 d-flex'>
                    <Col lg={7} xxl={8} xs={6} className='ps-lg-0 pos-right-scs'>
                        <div className='right-content mb-3'>
                            <div className="d-sm-flex align-items-center flex-xxl-nowrap flex-wrap bg-custom-grey">
                                ...
                                />
                                <HeaderAllButton holdListData={holdListData} goToHoldScreen={onClickHoldModel} goToDetailScreen={onClickDetailsModel} onClickFullScreen={onClickFullScreen} opneCalculator={opneCalculator} setOpneCalculator={setOpneCalculator} orderType={orderType} setOrderType={setOrderType} />
                            </div>
                        </div>
                    </Col>
