        ...
        <tr key={index} className='align-middle'>
            <td className='text-nowrap text-nowrap ps-0'>
                <div className={'d-flex '}>
                    {
                        singleProduct?.image?.length > 0 ? <img src={singleProduct?.image[0]} className='product-img' alt={'/images/brand_logo.png?c77aff19bcd1d22cef86b3eb70e74e96'} /   >
                            : <img src={window.location.origin + '/images/brand_logo.png?c77aff19bcd1d22cef86b3eb70e74e96'} className='product-img'  />
                    }
                    <div>
                    <h4 className='product-name text-gray-900  text-capitalize text-truncate'>{singleProduct.name}</h4>
                    <span className='product-sku'>
                        {/*<span className="badge bg-light-info sku-badge">{singleProduct.code}</span>*/}
                        <i className="bg-red-400 bi bi-pencil-fill cursor-pointer ms-2 p-1 rounded text-white"
