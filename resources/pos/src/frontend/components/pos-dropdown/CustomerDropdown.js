...
const CustomerDropDown = (props) => {
    const {setSelectedCustomerOption, selectedCustomerOption, fetchAllCustomer, customers, customerModel, updateCustomer,customStyles} = props;
        ...
        <div className='select-box col-6 pe-sm-1 position-relative'>
            <InputGroup className='flex-nowrap '>
                ...
                <Select
                    ...
                    styles={customStyles}
                />
                <Button onClick={() => customerModel(true)} className='position-absolute nav-light-grey' ><FontAwesomeIcon icon={faUserPlus} /></Button>
            </InputGroup>
        </div>
    )
};
